function [retval] = cont_sim (tsam,tsam1,tsam2,tsam3,tsam4)
  ...
  plant_dis_tsam3 = c2d(palnt,tsam3,'tustin')
  plant_dis_tsam4 = c2d(pant,tsam4,'tustin')
  ...
  feedback_dis_tus_tsam1 = feedback(plant_sampled*dis_cont_tus_tsam1);
  feedback_dis_tus_tsam2 = feedback(plant_sampled*dis_cont_tus_tsam2);
  feedback_dis_tus_tsam3 = feedback(plant_sampled*dis_cont_tus_tsam3);
  feedback_dis_tus_tsam4 = feedback(plant_sampled*dis_cont_tus_tsam4);
