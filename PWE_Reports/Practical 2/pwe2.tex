...
returning from $R_2$ for measuring load voltage, as will be discussed on later
...
load voltage with as given by \eqref{eq:voltage_divider}.
...
\begin{itemize}
  \item Raspberry Pi. Used for implementing control loop and providing PWM
    output.
  \item MCP3008 A/D converter. As discussed earlier, at provides digital
